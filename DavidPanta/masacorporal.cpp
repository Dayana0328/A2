// Creado por David Panta
	...
	/*Para definir datos reales se antepone la palabra reservada float al identificador de la variable*/
		float JDPM_imc,JDPM_peso,JDPM_altura;
	...
	//Procedemos a decir que JDPM_imc va hacer igual a JDPM_peso, dividido para JDPM_altura multiolocadl por JDPM_altura
		JDPM_imc=JDPM_peso/(JDPM_altura*JDPM_altura);
	...
	/*Los condicionales IF, son una estructura de control condicional, también llamadas estructuras selectivas de casos simples*/
		}if(JDPM_imc>=18.5 && JDPM_imc<24.9){
